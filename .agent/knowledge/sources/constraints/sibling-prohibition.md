...
related:
  ...
  - protocols/abstraction-lateral.md
---
...
- `concepts/tier-hierarchy.md` — Vertical structure
- `protocols/abstraction-lateral.md` — Proper sibling generation
- Source: `.agent/assets/documentation_system.md` §3.6 Lateral Dependency Prohibition
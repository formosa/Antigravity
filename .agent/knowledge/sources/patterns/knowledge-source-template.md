...
related:
  ...
  - patterns/manifest-structure.md
---
...
>
> **Excludes**: Tag syntax (see `tag-syntax.md`); manifest structure (see `manifest-structure.md`).
...
- `patterns/tag-syntax.md` — RST directive format
- `patterns/manifest-structure.md` — Reconciliation format

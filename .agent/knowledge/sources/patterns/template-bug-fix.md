...
related:
  - patterns/template-new-feature.md
  - constraints/tag-deprecation-lifecycle.md
---
...
>
> **Excludes**: New feature documentation (see `template-new-feature.md`); deprecation procedures.
...
- `patterns/template-new-feature.md` — New feature template
- `constraints/tag-deprecation-lifecycle.md` — Tag preservation rules
- `patterns/tag-syntax.md` — Tag format

...
related:
  - protocols/reconciliation-dirty-flag.md
  - protocols/reconciliation-inventory.md
---
...
- `protocols/reconciliation-dirty-flag.md` — When to set DIRTY
- `protocols/reconciliation-inventory.md` — Inventory maintenance

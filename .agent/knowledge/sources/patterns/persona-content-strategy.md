...
related:
  - patterns/knowledge-source-template.md
---
...
context_globs:
  - "docs/01_brd/*.rst"
  - ".agent/rules/brd-*.md"
  - ".agent/knowledge/sources/concepts/tier-brd.md"
```
...
- `patterns/knowledge-source-template.md` — Template specification
...
- `concepts/tier-fsd.md` — Parent tier (behavior)
- `concepts/tier-icd.md` — Next tier (contracts)
- Source: `.agent/assets/documentation_system.md` §2.4 System Architecture Document
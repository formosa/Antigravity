...
related:
  - patterns/evaluation-framework.md
...
>
> **Excludes**: Agent implementation details; evaluation metrics (see `evaluation-framework.md`).
...
- `concepts/tier-hierarchy.md` — Tier structure
- `patterns/evaluation-framework.md` — Agent evaluation metrics
- `protocols/traceability-chain.md` — Chain validation

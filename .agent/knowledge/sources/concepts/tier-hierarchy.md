...
requires:
  ...
  - concepts/ddr-overview.md
related:
  - concepts/information-flow.md
  - concepts/tier-brd.md
  - concepts/tier-nfr.md
  - concepts/tier-fsd.md
  - concepts/tier-sad.md
  - concepts/tier-icd.md
  - concepts/tier-tdd.md
  - concepts/tier-isp.md
---
...
- `concepts/ddr-overview.md` — DDR foundational principles
- `concepts/information-flow.md` — Citation and cascade mechanics

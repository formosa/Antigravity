...
related:
  - concepts/tier-nfr.md
  - constraints/brd-technology-agnostic.md
  - constraints/brd-measurable-metrics.md
tiers:
  - BRD
agents:
  - brd_strategist
...
- `concepts/tier-hierarchy.md` — Position in seven-tier structure
- `concepts/tier-nfr.md` — Next tier (boundaries)
- `constraints/brd-technology-agnostic.md` — No tech terms rule

...
- `concepts/tier-hierarchy.md` — The seven-tier structure
- `protocols/abstraction-upward.md` — Synthesizing missing parents
- `protocols/abstraction-downward.md` — Decomposing requirements

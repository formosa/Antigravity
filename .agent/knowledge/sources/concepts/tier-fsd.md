...
related:
  ...
  - constraints/fsd-no-implementation.md
tiers:
  - FSD
agents:
  - fsd_analyst
...
- `concepts/tier-nfr.md` — Parent tier (boundaries)
- `concepts/tier-sad.md` — Next tier (structure)
- `constraints/fsd-no-implementation.md` — No code rule

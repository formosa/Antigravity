...
related:
  ...
  - constraints/sibling-prohibition.md
agents:
...
Document chain status for each traced tag using the standard report format from `traceability-chain.md`.
...
- `protocols/traceability-chain.md` — Full validation protocol
- `constraints/tag-citation-required.md` — Citation mandate
- `constraints/sibling-prohibition.md` — Sibling citation prohibition

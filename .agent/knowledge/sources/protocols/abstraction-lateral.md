...
- Do not cite each other (see `sibling-prohibition.md`)
...
- `protocols/abstraction-upward.md` — Creating missing parents
- `protocols/abstraction-downward.md` — Decomposing parents
- `constraints/sibling-prohibition.md` — No peer citations

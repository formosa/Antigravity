...
related:
  - sources/protocols/traceability-chain.md
---
...
- `sources/patterns/metadata-schema.md` — Validation rules
- `sources/patterns/source-citation-style.md` — Provenance syntax
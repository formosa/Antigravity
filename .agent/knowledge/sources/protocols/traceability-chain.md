...
related:
  - constraints/tag-citation-required.md
  - protocols/impact-analysis.md
agents:
...
> **Exception (Decomposition):** An Atomic tag (`TIER-N.M`) MAY cite its direct Block header (`TIER-N`) as defined in `constraints/sibling-prohibition.md`.
...
| Orphan         | No parent citation   | Use `abstraction-upward.md` |
...
- `concepts/information-flow.md` — Traceability principles
- `constraints/tag-citation-required.md` — Citation mandate
- `protocols/impact-analysis.md` — Downstream effects

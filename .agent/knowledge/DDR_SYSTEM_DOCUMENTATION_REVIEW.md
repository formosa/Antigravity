...
3. **Cross-layer `related` path convention inconsistency**
...
4. **Index files are key governance documents but do not follow frontmatter template**
...
5. **Source citation style is inconsistent across documents**
...
6. **Context layer appears project-specific to “Maggie,” while repository is “Antigravity”**

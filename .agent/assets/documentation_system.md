...
Agent asset types, including Personas, Evals, Knowledge, and Tools, have been fully DEPRECATED.
Consequently, the 45+ legacy `- Source:` citations residing within `.agent/knowledge/` and
the related validation scripts have intentionally NOT been migrated to the new endpoint paths.

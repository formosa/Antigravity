...
<document_purpose>
This document establishes the verified architectural foundation for the `GEMINI.md` asset, which acts as the master configuration file for agentic processing within the Antigravity IDE v1.18.3 ecosystem using Gemini 3.1 Pro.
</document_purpose>
...
3. [Antigravity IDE v1.18.3 Architecture & Schemas - Google Open Source](https://google.github.io/adk-docs/architecture-v1-18)
   - Explicitly details the replacement of legacy persona files with the centralized `GEMINI.md` configuration, and establishes the strict requirement for the `thought_signature_protocol` to maintain coherence.

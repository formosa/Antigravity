...
document:
  ...
  type_values:
    ...
    - AXIOM_VIOLATION       # A rule or behaviour contradicts a stated axiom
...
#### Resolution Option A — [Short Label]
...
#### Resolution Option B — [Short Label]
...
#### Resolution Option A — Reintroduce `cites` as a Distinct Edge Type
...
#### Resolution Option B — Add Derivation Subtype Annotation to `derives`
...
#### Resolution Option A — Elevate CL to Derive from GPCL or SIL
...
#### Resolution Option B — Make CL Direction Context-Dependent via an `origin` Tag
...
#### Resolution Option A — Correct §3.5 Invariant Language with Explicit Exception
...
#### Resolution Option B — Establish a Single Authoritative Source Policy
...
#### Resolution Option A — Formally Classify Rules as Structural vs. Semantic
...
#### Resolution Option B — Create a Semantic Validation Extension (SVE)
...
#### Resolution Option A — Add a GPCL/FCL Disambiguation Rule
...
#### Resolution Option B — Split GPCL into Regulatory-GPCL and Quality-ORL as Distinct Sections with Cross-Tier Citation Rules
...
#### Resolution Option A — Add §3.8 "Node Status Lifecycle" with a Formal Transition Table
...
#### Resolution Option B — Express the State Machine in the YAML Schema as a Machine-Verifiable Contract
...
#### Resolution Option A — Define SUPERSEDE as a Single Atomic Transaction with Guaranteed Rollback
...
#### Resolution Option B — Introduce a SUPERSEDE_PENDING Intermediate Status
...
#### Resolution Option A — Define UNBUNDLE as a Two-Phase Operation with Pre-Flight Scan
...
#### Resolution Option B — Require Structured Front Matter in Express Mode Nodes
...
#### Resolution Option A — Define a Normative ARE Confidence Scoring Schema in §9
...
#### Resolution Option B — Delegate Confidence Scoring to a Configurable Scoring Profile
...
#### Resolution Option A — Add JSON Schema 2020-12 Pattern Properties Constraint
...
#### Resolution Option B — Introduce a Dedicated ExtensionAnnotation Schema Type
...
#### Resolution Option A — Resolve the ORL-R7 Mapping and Update Status
...
#### Resolution Option B — Introduce a `"Finalized-Pending-[AUDIT-ID]"` Status Value
...
#### Resolution Option A — Add `paused` to ARE Activation States
...
#### Resolution Option B — Add an Explicit Pool Snapshot Operation
...
#### Resolution Option A — Add FCL-R7 to Mandate Data Entity Enumeration in FCL
...
#### Resolution Option B — Restrict DDE's FCL Annotation Contract

...
#### Option A: Leverage Document Profiles
...
#### Option B: Add Explicit Conditional Requirement
...
1. **Architectural Coherence:** Option A aligns the issue with broader profile-based root repair; Option B is the smaller local patch.
2. **Profile Explicitness:** Option A makes Express Mode first-class at the document root; Option B still treats it as a conditional wrinkle.

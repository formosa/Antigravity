...
#### Option A: Make Allowed Transitions the Sole Authority
...
#### Option B: Add Explicit Closed Transition Metadata
...
1. **Single Authority:** Option A collapses lifecycle semantics into one graph; Option B retains a parallel prohibition surface.
2. **Patch vs Cleanup:** Option B is more localized, but Option A fixes the model that caused the drift.

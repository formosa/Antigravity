...
#### Option A: Centralize Rule-ID Definitions
...
#### Option B: Add Pattern Constraints Per Rule Family
...
1. **Maintainability:** Option A consolidates shared logic; Option B repeats it at each field.
2. **Repair Speed:** Option B is faster to patch in place, but Option A lowers future drift risk.

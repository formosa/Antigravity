...
### 1.1 Changes from v5.0

| Area                         | v5.0                                                             | v6.0 (This Spec)                                                                                                                                                        | Rationale                                                                                                                                           |
| ---------------------------- | ---------------------------------------------------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------- |
...
> `lifecycle.status_transitions` block in `ddr_system_v6.0.yaml`.
...
> **Machine Authority:** `ddr_system_v6.0.yaml` → `lifecycle.status_transitions`
...
| v3.1.1 Tier | v4.0/v6.0 Destination | Migration Notes                                                                                      |
| ----------- | --------------------- | ---------------------------------------------------------------------------------------------------- |
| XPD         | XPD                   | Unchanged                                                                                            |
| SIL         | SIL                   | Unchanged                                                                                            |
...
| v3.1.1 Rule ID         | v4.0/v6.0 Destination | Consolidation Status | Notes                                                                                        |
| ---------------------- | --------------------- | -------------------- | -------------------------------------------------------------------------------------------- |
...
*DDR System v6.0 — Deterministic Design for Software Excellence*

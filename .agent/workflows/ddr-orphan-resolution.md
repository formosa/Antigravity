...
inputs:
  ...
  - name: direction
    ...
    required: false
context:
  - ".agent/knowledge/sources/protocols/abstraction-upward.md"
  - ".agent/knowledge/sources/protocols/abstraction-downward.md"
  - ".agent/knowledge/sources/protocols/abstraction-lateral.md"
outputs:
  - name: created_tag_id
    type: string
...
## Phase 3: Execute
**Upward**: Follow `.agent/knowledge/sources/protocols/abstraction-upward.md`
```powershell
...
**Downward**: Follow `.agent/knowledge/sources/protocols/abstraction-downward.md`

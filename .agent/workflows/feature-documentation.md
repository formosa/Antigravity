...
inputs:
  ...
  - name: skip_tiers
    ...
    required: false
context:
  - ".agent/knowledge/sources/patterns/worked-example-feature.md"
  - ".agent/knowledge/sources/concepts/tier-hierarchy.md"
  - ".agent/knowledge/sources/protocols/classification-decision-tree.md"
outputs:
  - name: tag_chain
    type: object

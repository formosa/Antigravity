# asset-workflow Skill Lifecycle

<document_purpose>
This document records lifecycle governance, canonical schema relationships, and modification history for the `asset-workflow` skill.
</document_purpose>
...
5. `.agent/skills/asset-workflow/scripts/` - authoritative local tooling for workflow scaffolding, validation, and index synchronization.

...
class AmbiguityResolver:
    ...
    Implements the scoring protocol from classification-scoring.md with
    ...
    def __init__(
        ...
        Implements: Protocol from classification-scoring.md
        """
    ...
    def resolve(
        ...
        Requirements
        ------------
        |classification-scoring.md| - Multi-factor scoring protocol
        """
    ...
    def _calculate_tier_scores(
        ...
        Implements: classification-scoring.md Step 2
    ...
    def _select_tier(
        ...
        Implements: classification-scoring.md Step 4

...
2. Establish the base structure according to the `.agent/assets/schemas/workflow/workflow.d.ts` schema.
...
- `.agent/assets/schemas/workflow/workflow.d.ts`
- `.agent/assets/schemas/workflow/example.md`
</resources_reference>

#!/usr/bin/env python3
"""
Validator for Resolution Report artifacts used by agent-create-issue-report.
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Validate Resolution Report artifacts.")
    parser.add_argument("path", help="Path to the report markdown file.")
    parser.add_argument(
        "--mode",

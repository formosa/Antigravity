...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        ...
        epilog=(
            ...
            "directories should use asset-<asset-family>. Artifact-Centric Owners should prefer "
            "artifact-<artifact-family>. Routing contracts should prefer *-router. "
            "Schema-authoring contracts remain outside those naming families."
        ),
    )
    parser.add_argument(
        "skill_name",
        help="Lowercase hyphen-case skill name. Runtime-routed owners should use asset-<asset-family>, Artifact-Centric Owners should prefer artifact-<artifact-family>, and routers should prefer *-router.",
    )

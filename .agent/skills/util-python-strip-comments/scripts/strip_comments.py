...
Meta
----
Skill Definition: .agent/skills/util-python-strip-comments/SKILL.md
Workflow Role   : Code Sanitizer / Obfuscator
Architect       : Antigravity IDE (Adversarial Lead)

Usage
-----
    python strip_comments.py <target_file> [--dry-run]
...
def main() -> int:
    ...
    """
    if len(sys.argv) < 2:
        print("Usage: python strip_comments.py <target_file> [--dry-run]", file=sys.stderr)
        return 1

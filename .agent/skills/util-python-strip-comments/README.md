# util-python-strip-comments Skill Lifecycle

<document_purpose>
This document records lifecycle governance, canonical schema relationships, and modification history for the `util-python-strip-comments` skill.
</document_purpose>
...
| 2026-04-02 | 1.0.2 | patch | Governance | Clarified trigger boundaries, removed unused scaffold artifacts and self-schema references from SKILL.md, and synchronized the vendored skill schema mirror to the repaired canonical contract. |

...
- **Examples**: `resources/finance.md` for financial schemas, `resources/mnda.md` for company NDA template, `resources/policies.md` for company policies, `resources/api_docs.md` for API specifications

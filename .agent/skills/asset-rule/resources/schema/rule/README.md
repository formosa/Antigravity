# DESIGN_JUSTIFICATION: Antigravity Rule Assets v1.3.1
...
4. `.agent/skills/asset-rule/scripts/update_index.py`
5. `.agent/skills/asset-rule/SKILL.md`
...
- `asset-rule` owns the rule lifecycle end to end: scaffolding from the canonical example, structural validation of live rules, and deterministic regeneration of `.agent/rules/index.md`.
...
2. Local validator contract: `.agent/skills/asset-rule/scripts/quick_validate.py`
3. Local scaffolding contract: `.agent/skills/asset-rule/scripts/init_rule.py`
4. Local rules-index contract: `.agent/skills/asset-rule/scripts/update_index.py`

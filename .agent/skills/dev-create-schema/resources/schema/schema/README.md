...
2. `.agent/skills/dev-create-schema/scripts/validate_schema.py`
3. `.agent/skills/dev-create-schema/scripts/scaffold_schema.py`
4. `.agent/skills/dev-create-schema/scripts/update_index.py`
5. `.agent/skills/dev-create-schema/SKILL.md`
...
2. Local validator contract: `.agent/skills/dev-create-schema/scripts/validate_schema.py`
3. Local scaffolding contract: `.agent/skills/dev-create-schema/scripts/scaffold_schema.py`
4. Local index contract: `.agent/skills/dev-create-schema/scripts/update_index.py`
...
| 2026-04-01 | v1.20.3 | Repair | Replaced stale issues-tracker content with the correct `SchemaFileDefinition` contract and aligned the local authority surface with dev-create-schema. |

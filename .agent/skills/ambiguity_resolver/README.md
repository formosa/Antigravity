...
The **Ambiguity Resolver** is a Claude Skill that resolves ambiguous DDR tier classifications using multi-factor scoring when information fragments match multiple tiers. It implements the complete scoring protocol from `classification_scoring.md` with tie-breaker rules and contextual validation.
...
- **DDR Documentation**: `classification_scoring.md`, `tier_hierarchy.md`

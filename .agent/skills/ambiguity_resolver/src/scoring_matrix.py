...
Implements the scoring weights from classification_scoring.md §Step 1.
"""
...
class ScoringMatrix:
    ...
    Implements the 10-factor weights from classification_scoring.md:
    ...
    def __init__(self, weights_config: Dict):
        ...
        Implements: classification_scoring.md Step 1 matrix
        """

---
type: rule
name: sys-antigravity-types
activation: always_on
priority: 100
severity: mandatory
description: "Enforces strict schema compliance for all Antigravity agent asset definition files based on the interfaces in .agent/assets/antigravity_types.d.ts."
---
